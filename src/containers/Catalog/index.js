        ...
        return (
            <div>
                < Filter subject={"Transmission"} list={['Automatic', 'Manual']}
                         onFilterClick={this.transmissionFilterChange} filter={"transmission"}/>
                < Filter subject={"Maker"} list={['Ferrari', 'Porsche']} onFilterClick={this.filterChanged}
                         filter={"maker"}/>
                < Filter subject={"Year"} list={['2020', '2019', '2018', '2017', '2016']}
                         onFilterClick={this.filterChanged} filter={"year"}/>
                < Filter subject={"Doors"} list={['2', '4']} onFilterClick={this.filterChanged} filter={"doors"}/>
                < Filter subject={"Seats"} list={['2', '3', '4', '5', '6']} onFilterClick={this.filterChanged}
                         filter={"seats"}/>
            </div>
        );
    }
